...
| Duel-by-duel entry UI (BEST_OF_SINGLE) | `src/components/app/matchups/BestOfMatchCard.tsx` — Muster für duelNumber-basierte Erfassung, Stechschuss-Prompt, client-seitige Match-Statusauswertung     |
